...
function media_share_output($values) {
    ...
    if(substr($value, 0, 3) == 'tw:') {
        return '<div class="message-type-player event-video"><iframe src="//player.twitch.tv/?channel='.str_replace('tw:', '', $value).'&autoplay=false" frameborder="0" scrolling="no" height="378" width="100%" class="float-left"></iframe></div><div class="message-divider"></div>';
    }
